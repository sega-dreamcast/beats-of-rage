...
%MKISOFS% -V BEATS_OF_RAGE_RUMBLE_EDITION -G cd_root\IP.BIN -sysid "SEGA SEGAKATANA" -publisher "SENILE TEAM" -preparer "CDI4DC 0.3b" -appid "BEATS OF RAGE RUMBLE EDITION" -duplicates-once -sort sortfile.str -hide DISC_ID.TXT -l -o %DATA_FILE% cd_root
